 ...
 */
public final class Turret5Turn {
    ...
    public class Params {
        ...
        public static final double servoPosPerDeg = 1.0 / 85;
       // public static final double degPerServoPos = ;
    ...
    public final Servo turretServo;
    ...
    // ==================== CONSTRUCTOR ====================
    public Turret5Turn(HardwareMap hardwareMap, Telemetry telemetry, Pose2d initialPose) {
    ...
    public void sendTelemetry() {
        ...
        packet.put("Turret Current Pos", turretServo.getPosition());
    ...
    public void updateOdomTracking() {
     ...
     //   double currentTurretDeg = turretMotor.getCurrentPosition() / PARAMS.TICKS_PER_BIG_GEAR_DEGREE;
        double currentTurretDeg = (turretServo.getPosition() - 0.5)/ PARAMS.servoPosPerDeg;
    ...
    public void updateTurretAiming() {
      ...
      //  double currentDeg = turretMotor.getCurrentPosition() / PARAMS.TICKS_PER_BIG_GEAR_DEGREE;
        double currentDeg = (turretServo.getPosition() - 0.5)/ PARAMS.servoPosPerDeg;
        ...
        turretTargetPosition = (desiredDeg * PARAMS.servoPosPerDeg);

...
@Autonomous(name = "Apollo 2.0 - Blue Near Zone", group = "Autonomous")
public class ApolloNearZoneBlue extends LinearOpMode {
    ...
    private Pose2d firstFinishIntake = new Pose2d(-8.95, -57.2,Math.toRadians(-91.2));

...
public class StorageWLoaderWithGobildaServos {
    ...
    public static StorageWLoaderWithGobildaServos.Params PARAMS = new StorageWLoaderWithGobildaServos.Params();
    ...
    public StorageWLoaderWithGobildaServos(HardwareMap hardwareMap, Turret turret) {

...
@Autonomous(name = "FarZoneAutoRed_V2", group = "Autonomous")
public class FarZoneAutoRed_V2 extends LinearOpMode {
    ...
    private Pose2d shotingPos = new Pose2d(49.36, 18.4, Math.toRadians(-3.8));
    private Vector2d shotingVec=new Vector2d(50.36,17.4);
    private Pose2d finalPos = new Pose2d(37,19,0);
    ...
    public void runOpMode() {
        ...
        */
        ...
        Actions.runBlocking(new ParallelAction(myRobot.updateRobot(), myRobot.reverseTransfer(),new SequentialAction(myRobot.turnOnTrackingOnly(), myRobot.waitForTracking(),  myRobot.reverseTransferStop(),myRobot.turnOffUpdate())));
       ...
       // Actions.runBlocking(myRobot.turnOnUpdate());
        ...
        Actions.runBlocking(new ParallelAction(myRobot.updateRobot(),new SequentialAction(myRobot.turnOffTracking(), myRobot.intake(1),drive.actionBuilder(drive.localizer.getPose())
                .strafeToLinearHeading(new Vector2d(36.6, 20.8), Math.toRadians(111.4)).splineToLinearHeading(new Pose2d(31.4, 40.7, Math.toRadians(90)), 0, new TranslationalVelConstraint(15)).build(), //, new TranslationalVelConstraint(10)
        ...
        Actions.runBlocking(new ParallelAction(myRobot.updateRobot(), myRobot.reverseTransfer(),new SequentialAction( drive.actionBuilder(drive.localizer.getPose())
                .setReversed(true).splineToLinearHeading(shotingPos,0).build(), myRobot.turnOnTracking(),myRobot.shooterSpinUp(), myRobot.reverseTransferStop(), myRobot.turnOffUpdate() )));
        ...
        Actions.runBlocking(myRobot.turnOnUpdate());
        Actions.runBlocking(new ParallelAction(myRobot.updateRobot(), new SequentialAction( myRobot.turnOffTracking(),drive.actionBuilder(drive.localizer.getPose())
                .strafeToLinearHeading(new Vector2d(53.45, 48), Math.toRadians(80)).build(),myRobot.intake(1), myRobot.turnOffUpdate())));
        ...
        Actions.runBlocking(new ParallelAction(myRobot.updateRobot(),new SequentialAction( drive.actionBuilder(drive.localizer.getPose())
                .strafeToLinearHeading(new Vector2d(56, 56), Math.toRadians(90), new TranslationalVelConstraint(8)).strafeToLinearHeading(new Vector2d(52,42), Math.toRadians(89), new TranslationalVelConstraint(10)).build() , myRobot.intake(0), //, new TranslationalVelConstraint(10)
        ...
        Actions.runBlocking(new ParallelAction(myRobot.updateRobot(), new SequentialAction( drive.actionBuilder(drive.localizer.getPose())
                .strafeToLinearHeading(shotingVec,0).build(), myRobot.reverseTransferStop(),myRobot.turnOnTracking(),myRobot.shooterSpinUp(), myRobot.turnOffUpdate() )));
        //.setReversed(true).splineToLinearHeading(shotingPos,0).build(),
        //drive.updatePoseEstimate();

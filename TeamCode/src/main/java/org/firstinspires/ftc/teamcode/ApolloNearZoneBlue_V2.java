...
@Autonomous(name = "Apollo 2.5 - Blue Near Zone", group = "Autonomous")
public class ApolloNearZoneBlue_V2 extends LinearOpMode {
    ...
    private Pose2d firstStartIntake = new Pose2d(-21.75, -32.5, Math.toRadians(-45.2)); //(-7.66, -32.66, Math.toRadians(-86.44));
    private Pose2d firstFinishIntake = new Pose2d(-8.6, -51.0,Math.toRadians(-55.40)); //(-6.92, -57.7,Math.toRadians(-90.48));
    private Pose2d secondStartIntake = new Pose2d(2.25, -32.5, Math.toRadians(-45.2)); //(11.60, -32.0, Math.toRadians(-75.73));
    private Pose2d secondFinishIntake = new Pose2d(15.4, -51,Math.toRadians(-55.4)); //(19.83, -56.8,Math.toRadians(-75))

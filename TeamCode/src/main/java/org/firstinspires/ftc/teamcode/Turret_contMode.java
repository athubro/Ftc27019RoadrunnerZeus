 ...
 */
public final class Turret_contMode {
    public class Params {
        public static final double PID_INTERVAL = 0.1;

        public double kP = 38; //31.35->38
        public double kI = 0;
        public double kD = 0.0;
        public double kF = 10;

        public double toleranceRPM = 60;
    ...
    // Hardware
    public final Servo turret;          // continuous servo for yaw control
    ...
    // Constructor
    public Turret_contMode(HardwareMap hardwareMap, Telemetry telemetry) {
        ...
        PARAMS.kF = -1 * batteryVoltage + 23.5;
    ...
    public void calcTargetAngleSpeed() {
        ...
        if (tagFound) {
            if (x<82) {
                ...
                shooterAngleSetting = -0.00000504*x*x*x+0.000969*x*x-0.0681*x+1.82;
            } else{
            ...
            if (!constantRPM){
               ...
               targetRPM = 0.0123*x*x*x-1.89*x*x+99.9*x+820;
               //targetRPM = 0.0101*x*x*x-1.63*x*x+90.7*x+964;
                targetRPM = clamper(targetRPM, 2200, 3080);
            }

...
@Autonomous(name = "Apollo 2.5 - Red Near Zone", group = "Autonomous")
public class ApolloNearZoneRed_V2 extends LinearOpMode {
    ...
    private Pose2d shotingPos = new Pose2d(-32.66, 24.08, Math.toRadians(-45));
    ...
    private Pose2d firstStartIntake = new Pose2d(-7.66, 32.66, Math.toRadians(86.44));
    private Pose2d firstFinishIntake = new Pose2d(-6.92, 53.7,Math.toRadians(90.48));
    private Pose2d secondStartIntake = new Pose2d(11.60, 32.0, Math.toRadians(75.73));
    private Pose2d secondFinishIntake = new Pose2d(18.83, 55.8,Math.toRadians(75));
    private Pose2d secondShootingPos = new Pose2d(-17.9,18.50,Math.toRadians(-36.33));
        ...
        Actions.runBlocking(new ParallelAction(
                ...
                new SequentialAction(
                        ...
                        drive.actionBuilder(drive.localizer.getPose())
                                .splineToLinearHeading(firstStartIntake, 0).splineToLinearHeading(firstFinishIntake,0, new TranslationalVelConstraint(15))
                                .build(),
                        myRobot.intake(0),
                        myRobot.turnOffUpdate()

...
@TeleOp(name = "Red TeleOp 2.0", group = "TeleOp")
public class SolarStorm27019TeleOPRedAutoDrive extends LinearOpMode {
...
// auto drive
    ...
    public void runOpMode() {
        ...
        */
        ...
        telemetry.addLine("• Press B for FarZone Auto V3 (3.4,18,0)"); //(3.4,18,0)
        telemetry.addLine("• Press A for NearZone Auto V2 (-9.9, -17.5, -36.3°)"); //-9.9,17.50,Math.toRadians(-36.33)
        telemetry.addLine("• Press Y for Pos of FarZone V2 (37,19,0)"); //(37,19,0)
        ...
        while (flag) {
            ...
            if (gamepad1.bWasPressed()) {
                ...
                telemetry.clear();
                telemetry.update();
                pose = new Pose2d(-17.9,18.50, Math.toRadians(-36.33));
                poseSelected = true;
                //telemetry.clear();
                ...
                telemetry.clear();
                telemetry.update();
                pose = new Pose2d(37,19,0);
                poseSelected = true;
                //telemetry.clear();
                telemetry.addLine("Selected Pose FarZone V2 (37,19,0)");
                telemetry.addLine("Press X to confirm");
                telemetry.update();
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad2.backWasPressed()) {
                closeShotPose = new Pose2d(47, 39, 0 );
            }

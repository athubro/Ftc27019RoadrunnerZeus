...
public final class Turret5Turn {
    ...
    // ==================== CONSTRUCTOR ====================
    public Turret5Turn(HardwareMap hardwareMap, MecanumDrive myDrive, Telemetry telemetry, Pose2d initialPose) {
    ...
    public void calcTargetRPM() {
        double turretAngle=(turretServo.getPosition() -0.5)/ PARAMS.servoPosPerDeg;
    ...
    public void manualTurretAngle(double degrees) {
        ...
        // Convert to ticks and set target position
        turretTargetPosition = ((desiredDeg+0.5) * PARAMS.servoPosPerDeg);
        turretServo.setPosition(turretTargetPosition);
    }

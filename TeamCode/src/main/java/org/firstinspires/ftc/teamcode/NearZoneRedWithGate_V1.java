...
@Autonomous(name = "V1 - Red Near Zone With Gate", group = "Autonomous")
public class NearZoneRedWithGate_V1 extends LinearOpMode {
    ...
    private Vector2d shotingVector = new Vector2d(-20.66,20.06);
    ...
    private Pose2d firstStartIntake = new Pose2d(-13.9, 32.5, Math.toRadians(60.2)); //(-7.66, -32.66, Math.toRadians(-86.44));
    private Pose2d firstFinishIntake = new Pose2d(-7, 49,Math.toRadians(90.40)); //(-6.92, -57.7,Math.toRadians(-90.48));
    private Vector2d gatePath =  new Vector2d(-7.6, 38.2);
    private double gatePathHeading = Math.toRadians(88.7);
    private Pose2d gatePos = new Pose2d(0,60,Math.toRadians(180));
    private Pose2d secondStartIntake = new Pose2d(6.25, 32.5, Math.toRadians(50.2)); //(11.60, -32.0, Math.toRadians(-75.73));
    private Pose2d secondFinishIntake = new Pose2d(17.4, 56,Math.toRadians(60.4)); //(19.83, -56.8,Math.toRadians(-75))
    private Pose2d secondShootingPos = new Pose2d(-17.9,18.50, Math.toRadians(-36.33)); //(-9.9,-17.50,Math.toRadians(36.33));
    private Vector2d secondShootingVector = new Vector2d(-17.9,18.50);
    private double secondShootingHeading = Math.toRadians(-36.33);
    ...
    public void runOpMode() {
        ...
        Actions.runBlocking (myRobot.lookMotifRed());
        ...
        Actions.runBlocking(new ParallelAction(
                ...
                new SequentialAction(
                        ...
                        drive.actionBuilder(drive.localizer.getPose())
                                .splineToLinearHeading(firstStartIntake, 0).splineToLinearHeading(firstFinishIntake,0, new TranslationalVelConstraint(12)).strafeToLinearHeading(gatePath,gatePathHeading).turnTo(Math.toRadians(135)).strafeToLinearHeading(gatePos.position,gatePos.heading,new TranslationalVelConstraint(90)).waitSeconds(0.2)
                                .build(),
                        myRobot.intake(0),
       ...
       // drive.updatePoseEstimate();
        ...
        Actions.runBlocking(new ParallelAction(
                ...
                new SequentialAction(
                        ...
                        drive.actionBuilder(drive.localizer.getPose())
                                .strafeToLinearHeading(shotingVector, shotingHeading).waitSeconds(0.3).build(),
        ...
        Actions.runBlocking(new ParallelAction(
                ...
                new SequentialAction(
                        myRobot.intake(0),
                        drive.actionBuilder(drive.localizer.getPose()).strafeToLinearHeading(secondShootingVector,secondShootingHeading).waitSeconds(0.4).build(),
                        myRobot.reverseTransferStop(),
                        myRobot.shooterSpinUp(),
                        myRobot.turnOnTracking(),

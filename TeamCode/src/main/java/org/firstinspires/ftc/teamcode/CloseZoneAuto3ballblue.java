...
@Autonomous(name = "CloseZoneAutoRed", group = "Autonomous")
public class CloseZoneAuto3ballblue extends LinearOpMode {

    private Turret  turretSystem;
    private MecanumDrive drive;
    //private Storage kickers;  // intake-free storage class
    private StorageWLoader kickers;
    private Pose2d startPose = new Pose2d(0, 0, 0); //36.84, -14.96 0; delta x should be 25.9
    ...
    private Pose2d finalPos = new Pose2d(3.4,18,-18);
    ...
    public void runOpMode() {
        ...
        */
        ...
        Actions.runBlocking(new ParallelAction(myRobot.updateRobot(),new SequentialAction(drive.actionBuilder(startPose)
                .strafeToLinearHeading(new Vector2d(30, -30), Math.toRadians(0)).build() //, new TranslationalVelConstraint(10)
        ...
        Actions.runBlocking(new ParallelAction(myRobot.updateRobot(),new SequentialAction(drive.actionBuilder(drive.localizer.getPose())
                .turnTo(Math.toRadians(-45)).build() //, new TranslationalVelConstraint(10)
                , myRobot.turnOffUpdate())));

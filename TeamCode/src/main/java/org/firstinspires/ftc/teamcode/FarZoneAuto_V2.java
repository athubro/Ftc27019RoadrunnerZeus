...
@Autonomous(name = "FarZoneAutoBlue_V2", group = "Autonomous")
public class FarZoneAuto_V2 extends LinearOpMode {
    ...
    private Pose2d shotingPos = new Pose2d(52, -18.7, 0);
    private Vector2d shotingVec=new Vector2d(53, -17.7 );

    private Pose2d finalPos = new Pose2d(40,-19,0);
    ...
    public void runOpMode() {
        ...
        */
        ...
        if (turretSystem.motiff[0].equals("G")) { //GPP
            ...
            motiffSequence3 = new SequentialAction(myRobot.loadGreenAction(),myRobot.afterLoad() ,myRobot.loadPurpleAction(),myRobot.lastAfterLoad()); //
            ...
            motiffSequence3 = new SequentialAction(myRobot.loadPurpleAction(),myRobot.afterLoad(), myRobot.loadGreenAction(),myRobot.lastAfterLoad()); //, myRobot.loadGreenAction(),myRobot.afterLoad(), myRobot.loadPurpleAction(),myRobot.afterLoad()
        } else { //PPG
            ...
            motiffSequence3 = new SequentialAction(myRobot.loadPurpleAction(),myRobot.afterLoad(), myRobot.loadPurpleAction(),myRobot.lastAfterLoad()); //
        }
        /*
       ...
       // Actions.runBlocking(myRobot.turnOnUpdate());
        ...
        Actions.runBlocking(new ParallelAction(myRobot.updateRobot(),new SequentialAction(myRobot.turnOffTracking(), myRobot.intake(1),drive.actionBuilder(drive.localizer.getPose())
                .splineTo(new Vector2d(49.614, -35.1), Math.toRadians(-108.4)).splineTo(new Vector2d(43, -57), Math.toRadians(-90), new TranslationalVelConstraint(15)).build(), //, new TranslationalVelConstraint(10)
        ...
        Actions.runBlocking(new ParallelAction(myRobot.updateRobot(), myRobot.reverseTransfer(),new SequentialAction( drive.actionBuilder(drive.localizer.getPose())
                .setReversed(true).splineToLinearHeading(shotingPos,0).waitSeconds(0.4).build(), myRobot.turnOnTracking(),myRobot.shooterSpinUp(), myRobot.reverseTransferStop(), myRobot.turnOffUpdate() )));
        ...
        Actions.runBlocking(myRobot.turnOnUpdate());
        Actions.runBlocking(new ParallelAction(myRobot.updateRobot(), new SequentialAction( myRobot.turnOffTracking(),drive.actionBuilder(drive.localizer.getPose())
                .splineTo(new Vector2d(67.45, -58.65), Math.toRadians(-73)).build(),myRobot.intake(1), myRobot.turnOffUpdate())));
        ...
        Actions.runBlocking(new ParallelAction(myRobot.updateRobot(),new SequentialAction( drive.actionBuilder(drive.localizer.getPose())
                .splineTo(new Vector2d(70, -67), Math.toRadians(-89), new TranslationalVelConstraint(10)).strafeToLinearHeading(new Vector2d(67,-55), Math.toRadians(-89), new TranslationalVelConstraint(18)).build() , myRobot.intake(0), //, new TranslationalVelConstraint(10)
        ...
        Actions.runBlocking(new ParallelAction(myRobot.updateRobot(), new SequentialAction( drive.actionBuilder(drive.localizer.getPose())
                .strafeToLinearHeading(shotingVec,0).waitSeconds(0.4).build(), myRobot.reverseTransferStop(),myRobot.turnOnTracking(),myRobot.shooterSpinUp(), myRobot.turnOffUpdate() )));

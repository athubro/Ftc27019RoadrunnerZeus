...
@TeleOp(name = "SolarStorm27019TeleOPRedV3", group = "TeleOp")
public class SolarStorm27019TeleOPRedV3 extends LinearOpMode {
        ...
        */
        ...
        while (flag) {
            ...
            if (!poseSelected) {
                ...
                telemetry.addLine();
                telemetry.addLine("Select your starting position:");
                telemetry.addLine("• Press B for Auto Pose (9, -13, 0°)");
                telemetry.addLine("• Press A for Origin Pose (0, 0, 0°)");
                telemetry.addLine("• Press Y for Dad Auto Pose (40, -19, 0°)");
            ...
            if (gamepad1.bWasPressed()) {
                ...
                poseSelected = true;
                telemetry.clear();
                telemetry.addData("Selected Pose", "Auto Pose (9, -13, 0°)");
                telemetry.addLine("Press X to confirm");
            } else if (gamepad1.aWasPressed()) {
                pose = new Pose2d(0, 0, 0);
                poseSelected = true;
                telemetry.clear();
                telemetry.addData("Selected Pose", "Origin Pose (0, 0, 0°)");
                telemetry.addLine("Press X to confirm");
            } else if (gamepad1.yWasPressed()) {
                pose = new Pose2d(40,-19,0);
                poseSelected = true;
                telemetry.clear();
                telemetry.addData("Selected Pose", "Dad Auto Pose (40, -19, 0°)");
                telemetry.addLine("Press X to confirm");
            } else if (gamepad1.dpadRightWasPressed()) {
                pose = new Pose2d(4,-35.4, Math.toRadians(23.4));
                poseSelected = true;
                telemetry.clear();
                telemetry.addData("Selected Pose", "Atharva Auto Pose (4, -35.4, 23.4°) 😊");
                telemetry.addLine("Press X to confirm");
            }

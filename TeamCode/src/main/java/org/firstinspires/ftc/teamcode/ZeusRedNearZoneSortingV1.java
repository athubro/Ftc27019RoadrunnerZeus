...
@Autonomous(name = "ZeusRedNearSortingZoneV1", group = "Autonomous")
public class ZeusRedNearZoneSortingV1 extends LinearOpMode {
    ...
    private Pose2d motiffPose = new Pose2d(-22.8958, 8.795, Math.toRadians(170.458));
    ...
    private Pose2d secondSpikeEnd = new Pose2d(6.746, 49.138, Math.toRadians(89.12));
    ...
    private Pose2d park = new Pose2d(-0.3, 35.8, Math.toRadians(16));
    ...
    public void runOpMode() {
        ...
        Actions.runBlocking(new ParallelAction(myRobot.updateRobot(),
                new SequentialAction( drive.actionBuilder(drive.localizer.getPose()).
                        strafeToLinearHeading(secondSpikeStart.position,secondSpikeStart.heading).build(), //70
...
//=============================motiff
        ...
        Actions.runBlocking(new SequentialAction (myRobot.detectMotiff(),
                drive.actionBuilder(drive.localizer.getPose()).strafeToLinearHeading(secondSpikeEnd.position,secondSpikeEnd.heading,new TranslationalVelConstraint(50)).build()
